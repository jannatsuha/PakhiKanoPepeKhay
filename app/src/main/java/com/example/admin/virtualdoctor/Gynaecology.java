...
public class Gynaecology extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle("Gynaecologists");

        recyclerView=findViewById(R.id.gynaeDocRecyclerview);
        ...
        for(int i=0;i<=list2.size()-1;i++) {
            ...
            databaseReference2 = FirebaseDatabase.getInstance().getReference().child("DoctorList").child(s).child("gynaecology");
            databaseReference2.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    doctorShowAdapter = new DoctorShowAdapter(Gynaecology.this, list1);
        ...
        doctorShowAdapter2= new DoctorShowAdapter(Gynaecology.this,list1);
