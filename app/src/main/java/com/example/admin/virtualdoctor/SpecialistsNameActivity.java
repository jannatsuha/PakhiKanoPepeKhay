...
//        });
        ...
        list2.clear();
        list2.add("Anesthesiology Specialist");
        list2.add("Burn Specialist");  list2.add("Breast Surgeon Specialist");  list2.add("Cardiology Heart Specialist");
        ...
        list2.add("Dental Specialist");  list2.add("Dermatology Specialist");  list2.add("Diabetes Specialist");
        list2.add("Eye Specialist");  list2.add("ENT Specialist");  list2.add("Gynaecology & Obstetrics Specialist");
        list2.add("Gastroenterology Specialist");  list2.add("Haematology Specialist");
        list2.add("Infertility Specialist");  list2.add("Kidney Specialist");  list2.add("Liver Specialist");
        list2.add("Medicine Specialist");  list2.add("Neuromedicine Specialist");  list2.add("Neuro Surgeons Specialist");
        list2.add("Nutritionist & Diet Specialist");  list2.add("Orthopaedics Specialist");  list2.add("Pain Management Specialist");
        list2.add("Pediatric Specialist");  list2.add("Psychologist Specialist");  list2.add("Rheumatology Specialist");
