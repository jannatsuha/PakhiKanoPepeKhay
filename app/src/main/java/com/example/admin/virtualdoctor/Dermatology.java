...
public class Dermatology extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle("Dermatology Specialists");

        recyclerView=findViewById(R.id.dermatologyDocRecyclerview);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        list1 = new ArrayList<DoctorModel>();
        list2=new ArrayList<String>();
        list3=new ArrayList<String>();
        list3=Singleton.getInstance().getFrameList();
        ...
        for(int i=0;i<=list3.size()-1;i++) {
            ...
            databaseReference2 = FirebaseDatabase.getInstance().getReference().child("DoctorList").child(s).child("dermatology");
            databaseReference2.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    doctorShowAdapter = new DoctorShowAdapter(Dermatology.this, list1);
