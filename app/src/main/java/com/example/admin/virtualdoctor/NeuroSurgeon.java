...
public class NeuroSurgeon extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_neuro_surgeon);
        this.setTitle("Neuro Surgeon Specialists");

        recyclerView=findViewById(R.id.neuroSurgeonDocRecyclerview);
        ...
        for(int i=0;i<=list2.size()-1;i++) {
            ...
            databaseReference2 = FirebaseDatabase.getInstance().getReference().child("DoctorList").child(s).child("neurosurgery");
            databaseReference2.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    doctorShowAdapter = new DoctorShowAdapter(NeuroSurgeon.this, list1);
        ...
        doctorShowAdapter2= new DoctorShowAdapter(NeuroSurgeon.this,list1);
