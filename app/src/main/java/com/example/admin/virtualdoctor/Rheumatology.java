...
public class Rheumatology extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle("Rheumatologists");

        recyclerView=findViewById(R.id.rheumatologyDocRecyclerview);
        ...
        for(int i=0;i<=list2.size()-1;i++) {
            ...
            databaseReference2 = FirebaseDatabase.getInstance().getReference().child("DoctorList").child(s).child("rheumatology");
            databaseReference2.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    doctorShowAdapter = new DoctorShowAdapter(Rheumatology.this, list1);
        ...
        doctorShowAdapter2= new DoctorShowAdapter(Rheumatology.this,list1);
