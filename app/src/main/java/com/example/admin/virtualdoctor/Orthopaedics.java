...
public class Orthopaedics extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle("Orthopaedics");

        recyclerView=findViewById(R.id.orthopedicDocRecyclerview);
        ...
        for(int i=0;i<=list2.size()-1;i++) {
            ...
            databaseReference2 = FirebaseDatabase.getInstance().getReference().child("DoctorList").child(s).child("orthopaedics");
            databaseReference2.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    doctorShowAdapter = new DoctorShowAdapter(Orthopaedics.this, list1);
        ...
        doctorShowAdapter2= new DoctorShowAdapter(Orthopaedics.this,list1);
