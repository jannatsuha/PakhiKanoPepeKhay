...
public class Nutritionist extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle("Nutritionists");

        recyclerView=findViewById(R.id.nutritionDocRecyclerview);
        ...
        for(int i=0;i<=list2.size()-1;i++) {
            ...
            databaseReference2 = FirebaseDatabase.getInstance().getReference().child("DoctorList").child(s).child("nutritionist");
            databaseReference2.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    doctorShowAdapter = new DoctorShowAdapter(Nutritionist.this, list1);
        ...
        doctorShowAdapter2= new DoctorShowAdapter(Nutritionist.this,list1);
