...
public class NeuroMedicine extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_neuro_medicine);
        this.setTitle("Neuro-Medicine Specialists");

        recyclerView=findViewById(R.id.neuroMedicineDocRecyclerview);
        ...
        for(int i=0;i<=list2.size()-1;i++) {
            ...
            databaseReference2 = FirebaseDatabase.getInstance().getReference().child("DoctorList").child(s).child("neuromedicine");
            databaseReference2.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    doctorShowAdapter = new DoctorShowAdapter(NeuroMedicine.this, list1);
        ...
        doctorShowAdapter2= new DoctorShowAdapter(NeuroMedicine.this,list1);
