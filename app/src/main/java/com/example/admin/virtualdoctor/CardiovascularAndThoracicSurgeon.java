...
public class CardiovascularAndThoracicSurgeon extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(int i=0;i<=list2.size()-1;i++) {
            ...
            databaseReference2 = FirebaseDatabase.getInstance().getReference().child("DoctorList").child(s).child("cardiovascular");
