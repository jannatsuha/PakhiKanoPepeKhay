...
public class Eye extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle("Eye Specialists");

        recyclerView=findViewById(R.id.eyeDocRecyclerview);
        ...
        for(int i=0;i<=list2.size()-1;i++) {
            ...
            databaseReference2 = FirebaseDatabase.getInstance().getReference().child("DoctorList").child(s).child("eye");
            databaseReference2.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    doctorShowAdapter = new DoctorShowAdapter(Eye.this, list1);
